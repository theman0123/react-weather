...
class Icon01n extends React.Component {
  render() {
    return (
    
<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width={this.props.width} height={this.props.height} viewBox="0 0 26.568 28.475" enableBackground="new 0 0 26.568 28.475"
	 xmlSpace="preserve">
<path id="_x30_2" fill="#83A5B3" d="M0.07,12.568C-0.703,20.506,5.035,27.59,12.969,28.4
